...
namespace ProjectInsta.Application.MyHubs
{
    public class MessageHub : Hub
    {
        ...
        public MessageHub(IMessageService messageService, IMapper mapper, IUserService userService, ICommentService commentService, ISubCommentService subCommentService)
        {
